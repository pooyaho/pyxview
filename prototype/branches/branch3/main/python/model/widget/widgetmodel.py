...
<Window x:Class="Wpf_mvvm.MainWindow"
    ...
    def getXamlCode(self, rowIndex=None, colIndex=None):
        dmClass = self.dataModel[self.dataModel.rindex(".") + 1:]
        dmDomain = self.dataModel[:self.dataModel.rindex(".")]

        return self.xamlTemplate.substitute(
            domain=dmDomain, dataModel=dmClass, content=self.layout.getXamlCode()
        )
        #        myString[:myString.rindex(".")],
